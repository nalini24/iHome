...
#import "MusicVideosViewController.h"

@interface MusicVideosViewController ()

@end

@implementation MusicVideosViewController
@synthesize  musicVideoTableView;
...
- (void)viewDidLoad
{
    ...
    musicVideoTableView.delegate=self;
